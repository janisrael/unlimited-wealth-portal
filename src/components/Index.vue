    ...
    <el-col v-if="verification === true" :span="24">
      ...
      <el-col :span="6" class="left-panel">
        <el-col :span="24" class="panel-header">
          ...
          <el-popover placement="bottom-end" title="All events in one place" width="200" trigger="hover" content="By clicking with your mouse on a specific date, you can see your booked events and other events, that happen trough-out the current month.">
